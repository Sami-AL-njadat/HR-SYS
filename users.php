											...
											<tr>
												<td>
													<h2 class="table-avatar">
														<a href="profile.php" class="avatar"><img style="height: 100%;" src="profiles/<?php echo htmlentities($result->Picture); ?>" alt="Profile Pic"></a>
												...
												<td class="text-right">
													<div class="dropdown dropdown-action">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_user"><i class="fa "></i>
																Edit</a>
															<a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_user"><i class="fa fa -r-5"></i>
																Delete</a>
														</div>
													</div>
												</td>
