                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-right ml-auto">
                            ...
                            <div class="view-icons">
                                ...
                                <a href="clients-list.php" class="list-view btn btn-link active"><i
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="client-profile.php" class="avatar"><img
                                                        src="clients/<?php echo htmlentities($row->Picture); ?>"
                                                        alt=""></a>
                                                <a
                                                    href="client-profile.php"><?php echo htmlentities($row->Company); ?></a>
                                            </h2>
                                        </td>
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right  ">
                                                    ...
                                                    <a href="#" class="dropdown-item" data-toggle="modal"
                                                        data-target="#delete_client" onclick="setClientsToDelete
