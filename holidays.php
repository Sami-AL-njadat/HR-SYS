                ...
                $(this).on('click', function(event) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#edit_holiday').find('input[name="holiday_name"]').val(
                                response.Holiday_Name);
                            $('#edit_holiday').find('input[name="holiday_date"]').val(
                                response.Holiday_Date);
                            $('#edit_holiday').find('input[name="holiday_id"]').val(
                                response.id);
                        },
