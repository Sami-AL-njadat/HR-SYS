											...
											<tr>
												<td>
													<h2 class="table-avatar">
														...
														<a href="profile.php"><?php echo $row->FirstName . " " . $row->LastName ?><span>Web Designer</span></a>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell col-md-4">Lorem ipsum dolor sit amet,
                                            consectetur adipiscing elit. Donec vel elit neque.</td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                ...
                                                <a href="profile.php">Tarah Shropshire <span>Android
                                                        Developer</span></a>
                                            </h2>
                                        </td>
                                        <td>8 Mar 2019</td>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                ...
                                                <a href="profile.php">Catherine Manseau <span>Android
                                                        Developer</span></a>
                                            </h2>
                                        </td>
                                        <td>8 Mar 2019</td>
