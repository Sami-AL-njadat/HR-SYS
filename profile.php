										...
										<div class="row">
											<div class="col-md-5">
												<div class="profile-info-left">
													...
													<h6 class="text-muted"><?php echo ($Dep) ?></h6>
													<small class="text-muted"><?php echo ($Des) ?></small>
													<div class="staff-id">Employee ID: <?php echo $result->Employee_Id; ?></div>
													<div class="small doj text-muted">Date of Join: <?php echo $result->Joining_Date; ?></div>
											...
											<div class="col-md-7">
												<ul class="personal-info">
													<li>
														...
														<div class="text"><a href=""><?php echo $result->Phone; ?></a></div>
													</li>
													<li>
														<div class="title">Email:</div>
														<div class="text"><a href=""><?php echo $result->Email; ?></a></div>
													</li>
													<!-- <li>
